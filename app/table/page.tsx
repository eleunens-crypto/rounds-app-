    ...
    <div style={S.page}>
      ...
      {isAdmin && adminTab === "scan" && (
        <div>
          ...
          {/* Bon-totaal: vinkje als het klopt (met knop naar delen), checklist als het niet klopt, altijd bijstelbaar */}
          {items.length > 0 && (() => {
            ...
            return (
              <div style={{ ...S.card, padding: "11px 14px", marginBottom: 12, background: match ? "rgba(39,174,96,0.10)" : mismatch ? "rgba(224,107,94,0.08)" : "#fff", border: match ? "1.5px solid rgba(39,174,96,0.5)" : mismatch ? "1.5px solid rgba(224,107,94,0.55)" : "1px solid rgba(16,24,40,0.08)" }}>
                ...
                {mismatch && (
                  <span style={{ display: "block", fontSize: 13.5, fontWeight: 800, lineHeight: 1.45, color: "#c0392b", marginBottom: 8 }}>⚠️ Totaal van de bon correct?</span>
                )}
                ...
                {mismatch && (
                  <div style={{ marginTop: 10, fontSize: 12.5, color: "#8a4514", lineHeight: 1.5 }}>
                    <div style={{ fontWeight: 700, marginBottom: 3 }}>Controleer alles goed — een scan kan fouten bevatten:</div>
            ...
            taxNode={
              <div style={{ marginTop: 6 }}>
                ...
                <div style={{ display: "flex", gap: 6, alignItems: "center", justifyContent: "flex-end", marginTop: 8 }}>
                  <button onClick={() => addTaxItem()} style={{ ...S.btn, fontWeight: 700, fontSize: 12.5, padding: "7px 14px" }}>🧮 BTW of andere kosten</button>
