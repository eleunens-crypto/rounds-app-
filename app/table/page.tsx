...
const STRINGS = {
  nl: {
    ...
    toAssignBtn: "Verder naar toewijzen →",
    toAssignHint: "Zo weet iedereen wat hij moet betalen.",
  ...
  fr: {
    ...
    toAssignBtn: "Vers l’attribution →",
    toAssignHint: "Ainsi chacun sait ce qu\u2019il doit payer.",
    ...
    <div>
      ...
      <div style={{ ...S.card, background: "linear-gradient(135deg,#fbfaff,#f1f2fb)", border: "1.5px solid rgba(90,108,166,0.25)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", borderTop: "1px solid rgba(90,108,166,0.18)", paddingTop: 10 }}>
          <span style={{ fontSize: 18, fontWeight: 700, color: "#5a6680" }}>{L.yourTotal}</span>
        ...
        {finalized && (
          <div id="gast-eindverdeling" style={{ marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(90,108,166,0.18)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 17.5, fontWeight: 800, color: "#1f8a4c" }}>{L.allHandledFinal}</span>
            </div>
            <div style={{ fontSize: 16, color: "#8a93a3", marginBottom: 8 }}>{L.fullBillInfo}</div>
            {participants.map((p) => {
              const pt = personTotal(p.id)
              const isMe = p.id === meId
